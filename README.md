...
| **Generic routing** | High | The fall-through drop, the run-down-through-`v` lemma, and the block lookup at any column are proven; remaining: the header lookup and the corridor up-turn-drop for arbitrary jump targets. |
