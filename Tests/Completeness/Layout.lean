...
example : (playfieldOf layoutProgram).get 0 0 = '>' :=
  layout_entry

example : (playfieldOf layoutProgram).get 7 2 = '|' :=
  layout_decz_branch

example : (playfieldOf layoutProgram).get 8 5 = 'v' :=
  layout_jog

example : (playfieldOf layoutProgram).get 12 9 = '@' :=
  layout_halt
