...
| **State simulation relations** | High | Define dimension-independent state simulations that preserve observations and step behavior, then lift them to whole runs. |
